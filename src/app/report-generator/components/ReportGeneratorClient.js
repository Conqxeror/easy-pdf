        ...
        <Card className="border border-border">
          ...
          <CardContent className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <div className="text-xs text-foreground mt-1">Choose a visual style for your report.</div>
            </div>
            <div>
              ...
              />
              <div className="text-xs text-foreground mt-1">Affects title and highlight color.</div>
            </div>
            <div>
              ...
              />
              <div className="text-xs text-foreground mt-1">Affects accent and divider color.</div>
            </div>
          </CardContent>
        </Card>
        {/* Generate Button */}
