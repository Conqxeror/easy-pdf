...
export default function PdfTableExtractorClient() {
  ...
  const toolData = toolsData.find(tool => tool.href === '/pdf-table-extractor');
  ...
  // Define tool content
  const toolName = toolData?.title || "Pdf Table Extractor";
  ...
  return (
    <ToolPageLayout
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'Pdf Table Extractor', href: '/pdf-table-extractor' }
      ]}
