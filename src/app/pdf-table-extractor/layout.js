...
export const metadata = generateEnhancedMetadata({
  ...
  canonicalUrl: "https://easy-pdf-murex.vercel.app/pdf-table-extractor",
  metadataBaseUrl: "https://easy-pdf-murex.vercel.app",
  toolName: "PDF Table Extractor",
  pageType: "tool",
  breadcrumbs: [
    { name: "Home", url: "https://easy-pdf-murex.vercel.app" },
    { name: "PDF Table Extractor", url: "https://easy-pdf-murex.vercel.app/pdf-table-extractor" }
  ]
});
