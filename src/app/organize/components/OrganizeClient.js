  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {numPages > 0 && (
          <div className="mt-4 p-4 bg-background dark:bg-background shadow-inner border border-border dark:border-border space-y-4">
              ...
              {pageOrder.map((originalPageIndex, displayIndex) => (
                <li
                  ...
                  className={`relative flex flex-col items-center p-2 border group
                      ...
                      dragItem.current !== displayIndex
                      ? "border-border shadow-md scale-105"
                      : ""
                    }
                            `}
                ...
                >
                  <span
                    className={`text-sm font-medium mb-2 ${selected.includes(originalPageIndex)
                        ? "line-through"
                        : ""
                      }`}
                  >
        ...
        {organizedPdfUrl && !isProcessing && (
          <div className="flex flex-col gap-6 p-6 bg-background dark:bg-background shadow-lg border border-border dark:border-border mt-6">
