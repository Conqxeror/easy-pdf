      ...
      <div className="relative overflow-hidden py-16 px-6 my-8 px-6">
        ...
        <div className="container-standard px-6 py-8">
          ...
          <div className="mt-8 text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-background dark:bg-background/30 text-foreground dark:text-foreground font-medium mb-6">
              <Shield className="h-4 w-4" />
              Privacy First
            </div>
            
            <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground dark:text-foreground">
              Privacy Policy
            </h1>
        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <Card variant="elevated">
            <CardHeader>
              <CardTitle className="flex items-center gap-3">
                <div className="p-2 bg-background dark:bg-background/30">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground dark:text-foreground">
          ...
          <Card variant="elevated">
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <ul className="list-disc list-inside space-y-1 text-foreground dark:text-foreground text-sm">
                ...
                <p className="text-sm text-foreground dark:text-foreground mt-2">
                  Learn more: <Link href="https://vercel.com/docs/analytics/privacy-policy" className="text-foreground dark:text-foreground hover:underline" target="_blank" rel="noopener noreferrer">Vercel Analytics Privacy Policy</Link>
                </p>
              </div>
          ...
          <Card variant="elevated">
            ...
            <CardContent className="space-y-3">
              ...
              <p className="text-sm text-foreground dark:text-foreground mt-3">
          ...
          <Card variant="elevated">
            ...
            <CardContent>
              ...
              <div className="bg-background dark:bg-background/50 p-4 space-y-2">
                <p className="font-medium">easy-pdf Support</p>
                <p className="text-sm text-foreground dark:text-foreground">
                  Email: <Link href="mailto:privacy@easy-pdf.app" className="text-foreground dark:text-foreground hover:underline">privacy@easy-pdf.app</Link>
                </p>
                <p className="text-sm text-foreground dark:text-foreground">
                  Website: <Link href="https://easy-pdf.app" className="text-foreground dark:text-foreground hover:underline">https://easy-pdf.app</Link>
                </p>
              </div>
            </CardContent>
          </Card>
