...
export default function PdfAnnotationCollaborationClient() {
  ...
  const toolData = toolsData.find(tool => tool.href === '/pdf-annotation-collaboration');
  ...
  // Define tool content
  const toolName = toolData?.title || "Pdf Annotation Collaboration";
  ...
  return (
    <EnhancedToolPageLayout
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'Pdf Annotation Collaboration', href: '/pdf-annotation-collaboration' }
      ]}
