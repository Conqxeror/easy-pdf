...
export const metadata = generateEnhancedMetadata({
  ...
  description: "Split PDF files into multiple documents. Extract specific pages or ranges, or separate all pages. 100% client-side, privacy-first processing with no uploads.",
  keywords: [
