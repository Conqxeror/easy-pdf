...
export default function PdfFormCreatorClient() {
  ...
  const toolData = toolsData.find(tool => tool.href === '/pdf-form-creator');
  ...
  // Define tool content
  const toolName = toolData?.title || "Pdf Form Creator";
  ...
  return (
    <EnhancedToolPageLayout
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'Pdf Form Creator', href: '/pdf-form-creator' }
      ]}
