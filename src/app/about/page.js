      ...
      <div className="max-w-4xl mx-auto">
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-4">
            In an age where data privacy is paramount, easy-pdf stands apart. We
            are proud to be a{" "}
          ...
          <ul className="list-disc list-inside space-y-3 text-lg leading-relaxed pl-4">
            ...
            <li>
              ...
              : Our commitment to privacy is absolute, making easy-pdf a secure
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed mb-6">
            ...
            <span className="font-semibold text-white">online PDF toolkit</span>
            . Our growing collection of features empowers you to handle any PDF
            challenge with ease:
          </p>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed">
            We believe in transparency and the power of collaboration. easy-pdf
            is an{" "}
            <span className="font-semibold text-white">
              open-source project
            </span>
        ...
        <section className="mb-12">
          ...
          <p className="text-lg leading-relaxed">
            Developed with a deep understanding of the unique needs of users in
            India, easy-pdf is built to be accessible, efficient, and reliable
            for everyone. While our roots are in India, our vision is global. We
            strive to offer a universal{" "}
            <span className="font-semibold text-white">
              online PDF solution
            </span>{" "}
            that caters to diverse users around the world, providing a seamless
        ...
        <section className="mb-12">
          ...
          <ul className="list-disc list-inside space-y-3 text-lg leading-relaxed pl-4">
            <li>
              <span className="font-semibold text-white">Ultimate Privacy</span>
            ...
            <li>
              <span className="font-semibold text-white">Feature-Rich</span>: A
              comprehensive suite for every PDF need.
            </li>
            <li>
        ...
        <section className="w-full max-w-4xl mt-16 mb-8 text-center">
          <div className="bg-gradient-to-r from-blue-900/50 to-teal-900/50 p-8 rounded-xl border border-gray-700">
            ...
            <p className="text-xl leading-relaxed mb-8 text-gray-300">
              Ready to experience hassle-free PDF management? Explore our tools
