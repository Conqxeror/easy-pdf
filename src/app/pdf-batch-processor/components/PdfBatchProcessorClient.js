...
export default function PdfBatchProcessorClient() {
  ...
  const toolData = toolsData.find(tool => tool.href === '/pdf-batch-processor');
  ...
  // Define tool content
  const toolName = toolData?.title || "Pdf Batch Processor";
  ...
  return (
    <EnhancedToolPageLayout
      ...
      breadcrumbs={[
        { label: 'Home', href: '/' },
        { label: 'Pdf Batch Processor', href: '/pdf-batch-processor' }
      ]}
