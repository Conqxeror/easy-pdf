...
export default function ProtectClient() {
  ...
  useEffect(() => {
    return () => {
      if (protectedUrl) {
        try { if (protectedUrl) safeRevokeObjectURL(protectedUrl); } catch { /* ignore */ }
      }
    };
  }, [protectedUrl]);
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            ...
            className="w-full bg-background text-foreground border-border focus:border-border focus:ring-gray-600"
