...
export default function ReorderClient() {
  ...
  const handleDragEnter = useCallback((e, position) => {
    ...
    e.currentTarget.classList.add("border-border", "scale-105");
  }, []);
  ...
  const handleDragLeave = useCallback((e) => {
    ...
    e.currentTarget.classList.remove("border-border", "scale-105");
  }, []);
  ...
  const handleDragEnd = useCallback(
    (e) => {
      ...
      if (
        ...
        ].parentNode.classList.remove("border-border", "scale-105");
      }
      dragItem.current = null;
      dragOverItem.current = null;
    },
  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {numPages > 0 && (
          <div className="mt-4 p-4 bg-background shadow-inner border border-border space-y-4">
              ...
              {pageOrder.map((originalPageIndex, displayIndex) => (
                <li
                  ...
                  className={`relative flex flex-col items-center p-2 border group
                              ...
                              hover:border-border transition-all duration-200 cursor-grab
                ...
                >
                  <span className="text-sm font-medium mb-2 text-foreground">
                  ...
                  <canvas
                    ...
                    className="w-full h-auto max-w-[150px] border border-border bg-background" // Fixed width for thumbnail consistency
                  ></canvas>
                </li>
              ))}
            </ul>
        ...
        <div className="flex justify-center">
          <Button
            className="px-8 py-3 bg-gradient-to-r from-gray-700 to-gray-800 hover:from-gray-800 hover:to-gray-900 text-foreground shadow-lg hover:shadow-xl"
