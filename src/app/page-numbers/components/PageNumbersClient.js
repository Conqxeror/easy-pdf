  ...
  return (
    ...
    >
      <div className="space-y-6">
        ...
        {files.length > 0 && (
          <div className="mt-4 p-4 bg-background border border-border rounded-none">
          ...
          <div className="mt-6">
            ...
            <div className="flex flex-wrap gap-4">
              {Array.from({ length: Math.min(5, numPages) }).map((_, index) => (
                <div
                  key={index}
                  className="relative border-2 border-border p-2"
                >
                  <canvas
                    ref={(el) => (previewCanvasRef.current = el)}
                    className="w-32 h-40 bg-background border border-border rounded-none"
                  />
                  <div className="absolute top-1 left-1 bg-background/70 text-foreground text-xs px-1">
                    {index + 1}
                  </div>
                </div>
              ))}
              ...
              <CardContent className="space-y-6">
                <div>
                  ...
                  <div className="flex items-center space-x-2">
                    <input
                      ...
                      className="h-4 w-4 text-foreground bg-background border-border focus:ring-gray-600"
                    />
                    <label
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full p-2 bg-background text-foreground border border-border rounded-none"
                  />
                </div>
                  ...
                  <div>
                    ...
                    <div className="flex items-center space-x-2">
                      <input
                        ...
                        className="h-10 w-16 p-1 bg-background border border-border rounded-none"
                      />
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {[
                      ...
                      <button
                        ...
                        className={`p-2 text-xs border ${position === pos
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <input
                        ...
                        className="w-16 p-1 bg-background text-foreground border border-border text-sm rounded-none"
