...
export const toolsData = [
  ...
  icon: <Shield className="w-8 h-8 text-blue-600 preserve-color" />,
  ...
  icon: <GitCompare className="w-8 h-8 text-indigo-600 preserve-color" />,
  ...
  icon: <MessageSquare className="w-8 h-8 text-cyan-600 preserve-color" />,
