...
import { FileText, Split, Minimize2, RotateCw, Stamp, Lock, Unlock, Text, ListOrdered, Eraser, PlusCircle, Signature, Image as LucideImage, Search, FileHeart, Settings, Bookmark, Table, Layers, CheckCircle, Shield, EyeOff, GitCompare, MessageSquare, Calculator, QrCode, Award, Briefcase, Files } from "lucide-react";
...
export const toolsData = [
  ...
  },
  {
    ...
    keywords: ["pdf metadata editor", "edit pdf metadata", "pdf title editor", "document properties", "metadata editor"],
    seoTitle: "PDF Metadata Editor - Edit Document Properties Online",
    seoDescription: "Edit PDF metadata including title, author, subject, and keywords. Modify document properties with our free online PDF metadata editor tool.",
  ...
  },
  {
    ...
    seoTitle: "PDF Version Comparison - Compare PDF Documents Visually",
    seoDescription: "Compare different versions of PDF documents with visual diff highlighting. Track changes and differences between PDF versions easily.",
