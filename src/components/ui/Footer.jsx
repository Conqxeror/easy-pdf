...
const footerLinks = [
  {
    ...
    links: [
      ...
      { name: "OCR", href: "/ocr" },
      { name: "Advanced OCR", href: "/advanced-ocr" },
      { name: "Sign/Annotate PDF", href: "/sign" },
      { name: "PDF Form Filler", href: "/form-filler" },
      { name: "PDF Form Creator", href: "/pdf-form-creator" },
      { name: "Digital Signature", href: "/pdf-digital-signature" },
      { name: "PDF Redaction", href: "/pdf-redaction" },
      { name: "PDF Metadata Editor", href: "/pdf-metadata-editor" },
      { name: "PDF Bookmark Manager", href: "/pdf-bookmark-manager" },
      { name: "PDF Table Extractor", href: "/pdf-table-extractor" },
      { name: "PDF Accessibility Checker", href: "/pdf-accessibility-checker" },
      { name: "PDF Version Comparison", href: "/pdf-version-comparison" },
      { name: "PDF Batch Processor", href: "/pdf-batch-processor" },
      { name: "PDF Annotation Collaboration", href: "/pdf-annotation-collaboration" },
