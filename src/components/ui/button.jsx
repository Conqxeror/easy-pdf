    ...
    variants: {
      variant: {
        ...
        outline:
          ...
          "border border-gray-500 text-gray-800 shadow-xs hover:bg-accent hover:text-accent-foreground dark:bg-input/30 dark:border-gray-500 dark:hover:bg-input/50 dark:text-gray-200",
        secondary:
