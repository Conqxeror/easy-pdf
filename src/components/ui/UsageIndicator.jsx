...
const UsageIndicator = ({ className = '', compact = false }) => {
  ...
  return (
    <div className={`bg-background border border-border p-4 ${className}`}>
      <div className="flex items-center justify-between mb-3">
        <h3 className="text-sm font-medium text-foreground">Usage Status</h3>
  ...
  <CheckCircle className="w-8 h-8 text-green-400 mx-auto mb-2 preserve-color" />
        <p className="text-sm text-foreground mb-1">All Features Unlimited</p>
