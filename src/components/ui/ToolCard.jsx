...
export default function ToolCard({ tool, className }) {
  ...
  return (
    ...
    >
      <Card 
        className={cn(
          "text-center h-full group-hover:border-primary group-hover:shadow-lg transition-all duration-200",
      ...
      >
        ...
        <h3 className="text-h4 font-semibold text-foreground group-hover:text-primary mb-3 transition-colors">
          {tool.title}
          {isDisabled && (
