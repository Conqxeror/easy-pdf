  ...
  return (
    <div className={`${className}`}>
      <button
        ...
        className="flex items-center space-x-2 text-sm text-foreground hover:text-foreground dark:text-foreground dark:hover:text-foreground transition-colors"
      ...
      {isVisible && (
        <div className="absolute top-full left-0 mt-2 p-4 bg-background border border-border shadow-lg z-50 min-w-[280px]">
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <span className="text-sm text-foreground dark:text-foreground">Operations:</span>
              <span className="font-medium">{metrics.count}</span>
            </div>
            
            <div className="flex items-center justify-between">
              <span className="text-sm text-foreground dark:text-foreground">Average time:</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-foreground dark:text-foreground">Fastest:</span>
            ...
            <div className="flex items-center justify-between">
              <span className="text-sm text-foreground dark:text-foreground">Slowest:</span>
            ...
            {metrics.recent && metrics.recent.length > 0 && (
              <div className="pt-2 border-t border-border">
                <span className="text-sm text-foreground dark:text-foreground mb-2 block">
                  Recent trend:
                </span>
